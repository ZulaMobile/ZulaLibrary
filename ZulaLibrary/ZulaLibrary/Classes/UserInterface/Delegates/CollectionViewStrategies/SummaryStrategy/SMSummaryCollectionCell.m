...
@implementation SMSummaryCollectionCell
...
@implementation SMSummaryCollectionImageCell
...
- (void)adjustFrames
{
    ...
    self.image.frame = CGRectMake(padding, padding, backgroundWidth - padding * 2.0f, imageHeight);
