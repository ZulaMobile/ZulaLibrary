...
{
    STAssertTrue(2 == [navbar.componentDescriptions count], @"navbar compnent count");
    STAssertTrue([[navbar.componentDescriptions objectAtIndex:0] isKindOfClass:[SMComponentDescription class]], @"");
    STAssertTrue([[navbar.componentDescriptions objectAtIndex:1] isKindOfClass:[SMComponentDescription class]], @"");
    
    SMComponentDescription *desc = [navbar.componentDescriptions objectAtIndex:0];
    STAssertTrue([desc.title isEqualToString:@"Cool Content"], @"");
    
    desc = [navbar.componentDescriptions objectAtIndex:1];
    STAssertTrue([desc.title isEqualToString:@"Contact Us"], @"");
}

- (void)testGettingComponentControllers
{
    SMBaseComponentViewController *ctrl = [navbar componentAtIndex:0];
    STAssertTrue([ctrl isKindOfClass:[SMContentViewController class]], @"");
    
    ctrl = [navbar componentAtIndex:1];
    STAssertTrue([ctrl isKindOfClass:[SMContactViewController class]], @"");
}
*/
